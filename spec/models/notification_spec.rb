...
RSpec.describe NotifyWith::Notification, type: :model do
  ...
  context 'method #send_notification' do
    it 'should can set a notification type' do
      notification = NotifyWith::Notification.new.send_notification(type: notification_type)
      expect(notification.notification_type).to eq notification_type
    end

    it 'should can set a attached object' do
      notification = NotifyWith::Notification.new.send_notification(attached_object: message)
  ...
  context 'method #to' do
    it 'should can set a receiver' do
      notification = NotifyWith::Notification.new.to(receiver)
  ...
  it 'should create success with receiver, notification_type and attached_object' do
    notification = NotifyWith::Notification.new.send_notification(type: notification_type, attached_object: message)
                                   .to(receiver)
  ...
  it 'is invalid without attached_object' do
    notification = NotifyWith::Notification.new.send_notification(type: notification_type, attached_object: nil)
                                   .to(receiver)
    expect(notification).to be_invalid
  end
